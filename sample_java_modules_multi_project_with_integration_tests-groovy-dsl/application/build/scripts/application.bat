...
set CLASSPATH=
set MODULE_PATH=%APP_HOME%\lib\application-1.0.2.jar;%APP_HOME%\lib\utilities-1.0.2.jar;%APP_HOME%\lib\list-1.0.2.jar

@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" --module-path "%MODULE_PATH%" --module org.gradle.sample.app/org.gradle.sample.app.Main %*
